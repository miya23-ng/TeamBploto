...
public class measu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measu);

       /* TextView tex = findViewById(R.id.textView8);
        Animation anim = AnimationUtils.loadAnimation(this,R.anim.anime);
                tex.startAnimation(anim);*/
    ...
    private void onImageScan() {
        //画像読み込み
        Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.src3);
        Mat mat = new Mat();
